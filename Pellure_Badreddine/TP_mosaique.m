...
% Lecture des images
Im1 = imread('ulahup1.pgm'); % 'ulahup1.pgm' 'TEST_MOODLE_2025\BUILDING\building1.pgm'
Im2 = imread('ulahup2.pgm');
Im3 = imread('ulahup3.pgm'); 
Im1_coul = imread('ulahup_couleur1.jpg'); % 'ulahup_couleur1.jpg'
Im2_coul = imread('ulahup_couleur2.jpg');
Im3_coul = imread('ulahup_couleur3.jpg'); %TEST_MOODLE_2025\LaRochelle\im1.jpg
...
figure;
affichage_image(Im1_coul,'Image 1',1,3,1);
affichage_image(Im2_coul,'Image 2',1,3,2);
affichage_image(Im3_coul,'Image 3',1,3,3);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Imosbis = mosaiquebis(Im2,Im1,inv(H)); % inversion ordre im et / inv(H)
figure; 
...
figure;
affichage_image(Im3,'Image 3',1,2,1); 
[XY_3,Res_3] = harris(Im3,TailleFenetre,NbPoints,k); 
affichage_POI(Im3,XY_3,'POI Image 3',1,2,2); 

[XY_C2_23,XY_C3] = apparier_POI(Im2,XY_2,Im3,XY_3,TailleFenetre,seuil); 

H12 = homographie(XY_C1,XY_C2);
